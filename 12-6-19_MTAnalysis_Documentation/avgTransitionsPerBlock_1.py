...
for i in range(8):
    ...
    #plt.show()
    plt.savefig('correlation_1/Performance/PerBlock/avgTransitionsPerBlockPerson'+str(i))
...
plt.plot(x,func(x,*popt),label='Fitted curve top',color='b') #for the exponential fit
plt.text(4,0.1,'top 4 = '+str.format('{0:.4f}', popt[0])+'*exp('+str.format('{0:.4f}', popt[1])+'x)',fontsize=10) #for the exponential fit
...
last=a*np.exp(b*x[-1])
drop=(first-last)
print(' bottom:'+str(drop))


plt.plot(x,func(x,*popt),label='Fitted curve top',color='g') #for the exponential fit
plt.text(4,0.9,'Bottom 4 = '+str.format('{0:.4f}', popt[0])+'*exp('+str.format('{0:.4f}', popt[1])+'x)',fontsize=10) #for the exponential fit

plt.legend()

plt.savefig('correlation_1/Performance/PerBlock/avgTransitionsAllSubjectsPerBlock')
#plt.show()
