...
workbook=xlsxwriter.Workbook('Distance/DistanceIndividual.xlsx')
...
for per in range(8):
    ...
    for i in distRank:
        ...
        if(float(i[1])==float(presDist)):
            ...
            if(i==distRank[-1]):
                worksheet.write(row,col,presDist)
    ...
    for i in distRank:
        ...
        if(float(i[1])==float(presDist)):
            imp.append(d[distRank.index(i)])
            if(i==distRank[-1]):
                worksheet1.write(row,col,presDist)
    ...
    for i in distRank:
        ...
        if(float(i[1])==float(presDist)):
            imp.append(d[distRank.index(i)])
            if(i==distRank[-1]):
                worksheet2.write(row,col,presDist)
