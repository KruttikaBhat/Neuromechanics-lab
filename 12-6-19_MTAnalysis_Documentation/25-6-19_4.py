...
plt.savefig('correlation_2/Log/ErrorPlots/AllMT/AllSubjectsAvg')
...
for p in range(8):
    ...
    plt.legend(loc=4)
    plt.savefig('correlation_2/Log/ErrorPlots/AllMT/Person'+str(p+1))
    plt.close()
...
plt.legend(loc=4)
plt.savefig('correlation_2/Log/ErrorPlots/PerBlock/AllSubjectsAvg')
...
for p in range(8):
    ...
    plt.errorbar(x,y,yerr,label='bottom 4',color='g')
    plt.legend(loc=4)
    plt.savefig('correlation_2/Log/ErrorPlots/PerBlock/Person'+str(p+1))
...
plt.errorbar(x,y,yerr,label='bottom 4',color='g')
plt.legend(loc=4)
plt.savefig('correlation_2/Log/ErrorPlots/PerDay/AvgAllSubjects')
...
for p in range(8):
    ...
    x=np.arange(1,len(y)+1)
    print(x,y,yerr)
    plt.errorbar(x,y,yerr,label='bottom 4',color='b')
    plt.legend(prop={'size': 8},loc=4)
    plt.savefig('correlation_2/Log/ErrorPlots/PerDay/Person'+str(p+1))
