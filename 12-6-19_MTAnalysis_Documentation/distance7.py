...
workbook=xlsxwriter.Workbook('Distance/DistanceFrequency.xlsx')
...
for per in range(8):
    ...
    row=row+1
    worksheet.write_row(row,col,['Transition','Frequency','Distance','Improvement'])
    worksheet1.write_row(row,col,['Transition','Frequency','Distance','Improvement'])
    worksheet2.write_row(row,col,['Transition','Frequency','Distance','Improvement'])
    row=row+1
    ...
    for i in rank:
        ...
        if(diff<1):
            ...
            d.append(y[-1])
        distRank.append(dt[i[0]])


    worksheet.write_column(row,col,np.array(rank)[:,0])
    worksheet.write_column(row,col+1,np.array(rank)[:,1])
    worksheet.write_column(row,col+2,distRank)
    worksheet1.write_column(row,col,np.array(rank)[:,0])
    worksheet1.write_column(row,col+1,np.array(rank)[:,1])
    worksheet1.write_column(row,col+2,distRank)
    worksheet2.write_column(row,col,np.array(rank)[:,0])
    worksheet2.write_column(row,col+1,np.array(rank)[:,1])
    worksheet2.write_column(row,col+2,distRank)
    worksheet.write_column(row,col+3,d)
    ...
    worksheet1.write_column(row,col+3,d)
    ...
    worksheet2.write_column(row,col+3,d)
